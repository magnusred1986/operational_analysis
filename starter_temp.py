...
lst_df = {'df_chr_msc' : {'link': '//sim.local/data/Varsh/DPA/CHERY-ЮЗ/Payment/NP-Chery.xlsm',
                          ...
                          'brand' : 'CHERY',
                          'lst_sheet_name' : 'Авто',
                          'white_list_columns' : ['модель', 'vin', 'дата_заказа', 'дата_ф._выдачи', 'ф.дата_полн._опл.', 'сумма_спр.сч._(руб)', 'кре_нал'],
                          'order_columns': ['модель', 'vin', 'дата_заказа', 'дата_выдачи', 'дата_оплаты', 'сум_спр_сч', 'кре_нал', 'регион', 'бренд', 'бд', 'дата_изменения'],
          ...
          'df_kia_msc' : {'link': '//sim.local/data/Varsh/DPA/КИА-ЮЗ/NP-ЮЗ-Киа.xlsm',
                          ...
                          'brand' : 'KIA',
                          'lst_sheet_name' : 'Авто',
                          'white_list_columns' : ['модель', 'vin', 'дата_заказа', 'дата_ф._выдачи', 'ф.дата_полн._опл.', 'сумма_спр.сч._(руб)', 'б_н___нал'],
                          'order_columns': ['модель', 'vin', 'дата_заказа', 'дата_выдачи', 'дата_оплаты', 'сум_спр_сч', 'кре_нал', 'регион', 'бренд', 'бд', 'дата_изменения'],
                          'rename_col' : {'модель' : 'модель', 
                                          'vin' : 'vin', 
                                          'дата_заказа' : 'дата_заказа', 
          ...
          'df_ovp_msc_vved' : {'link': '//sim.local/data/Varsh/DPA/Юго-Запад/Payment/ОВП ЮЗ.xlsx',
                          ...
                          'white_list_columns' : ['модель', 'vin', 'дата_заказа__контракта', 'дата_выдачи', 'дата_полной_оплаты', 'цена_продажи,_руб.', 'примечание'],
                          'order_columns': ['модель', 'vin', 'дата_заказа', 'дата_выдачи', 'дата_оплаты', 'сум_спр_сч', 'кре_нал', 'регион', 'бренд', 'бд', 'дата_изменения'],
                          'rename_col' : {'модель' : 'модель', 
                                          'vin' : 'vin', 
          ...
          'df_bai_msc_varsh' : {'link': '//sim.local/data/Varsh/SalonHyundai/Секретари-оформители/внутренние отчеты/Склад BAIC Москва.xlsx',
                          ...
                          'brand' : 'BAIC',
                          'lst_sheet_name' : 'СКЛАД',
                          'white_list_columns' : ['модель', 'vin', 'дата_заключения_договора', 'дата_выдачи_клиенту', 'дата_полной_оплаты_ам_клиентом', 'сумма_оплаченная_клиентом', 'нал_кредит'],
                          'order_columns': ['модель', 'vin', 'дата_заказа', 'дата_выдачи', 'дата_оплаты', 'сум_спр_сч', 'кре_нал', 'регион', 'бренд', 'бд', 'дата_изменения'],
                          'rename_col' : {'модель' : 'модель', 
                                          'vin' : 'vin', 
